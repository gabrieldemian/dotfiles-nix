  ...
  config.programs.waybar = mkIf cfg.enable {
    ...
    settings = {
      mainBar = {
        ...
        modules-right = ["tray" "pulseaudio" "temperature" "memory" "network" "battery" "custom/ss" "custom/cycle_wall" "custom/expand" "cpu" "clock"];
        ...
        "custom/dynamic_pill" = {
          return-type = "json";
          exec = "~/dotfiles/modules/home-manager/hyprland/scripts/tools/start_dyn";
          escape = true;
        };
        "custom/ss" = {
          format = "{} ";
          exec = "~/dotfiles/modules/home-manager/hyprland/scripts/tools/expand ss-icon";
          on-click = "~/dotfiles/modules/home-manager/hyprland/scripts/screenshot";
        };
        "custom/cycle_wall" = {
          format = "{}";
          exec = "~/dotfiles/modules/home-manager/hyprland/scripts/tools/expand wall";
          on-click = "~/dotfiles/modules/home-manager/hyprland/scripts/tools/expand cycle";
        };
        "custom/expand" = {
          on-click = "~/dotfiles/modules/home-manager/hyprland/scripts/expand_toolbar";
          format = "{} ";
          exec = "~/dotfiles/modules/home-manager/hyprland/scripts/tools/expand arrow-icon";
        };
        "keyboard-state" = {
          numlock = true;
          capslock = true;
